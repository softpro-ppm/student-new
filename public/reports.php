                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="reportTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="<?php echo $reportType === 'students' ? '7' : ($reportType === 'fees' ? '6' : '5'); ?>" class="text-center py-4">
                            ...
                            <tr>
                                <?php if ($reportType === 'students'): ?>
                                    ...
                                    <td>
                                        ...
                                        $class = $statusClass[$row['status'] ?? 'inactive'] ?? 'bg-secondary';
                                        ?>
                                        <span class="badge <?php echo $class; ?>"><?php echo ucfirst($row['status'] ?? 'N/A'); ?></span>
                                    </td>
                                    <td><?php echo htmlspecialchars($row['phone'] ?? 'N/A'); ?></td>
                                    <td><?php echo htmlspecialchars($row['email'] ?? 'N/A'); ?></td>
                                    <td><?php echo isset($row['admission_date']) ? date('d/m/Y', strtotime($row['admission_date'])) : 'N/A'; ?></td>
                                    
                                <?php elseif ($reportType === 'fees'): ?>
                                    <td><strong><?php echo htmlspecialchars($row['student_name'] ?? 'N/A'); ?></strong></td>
                                    <td><strong>₹<?php echo number_format($row['amount'] ?? 0, 2); ?></strong></td>
                                    <td><span class="badge bg-info"><?php echo ucfirst($row['fee_type'] ?? 'N/A'); ?></span></td>
                                    <td>
                                        <?php
                                        $statusClass = [
                                            'paid' => 'bg-success',
                                        ...
                                        $class = $statusClass[$row['status'] ?? 'pending'] ?? 'bg-secondary';
                                        ?>
                                        <span class="badge <?php echo $class; ?>"><?php echo ucfirst($row['status'] ?? 'N/A'); ?></span>
                                    </td>
                                    <td><?php echo isset($row['due_date']) ? date('d/m/Y', strtotime($row['due_date'])) : 'N/A'; ?></td>
                                    <td><?php echo isset($row['paid_date']) ? date('d/m/Y', strtotime($row['paid_date'])) : '-'; ?></td>
                                    
                                <?php elseif ($reportType === 'results'): ?>
                                    <td><strong><?php echo htmlspecialchars($row['student_name'] ?? 'N/A'); ?></strong></td>
                                    <td><?php echo htmlspecialchars($row['assessment_title'] ?? 'N/A'); ?></td>
                                    <td><?php echo round($row['percentage'] ?? 0, 1); ?>%</td>
                                    <td>
                                        <?php
                                    ...
                                    <td><?php echo isset($row['completed_at']) ? date('d/m/Y', strtotime($row['completed_at'])) : 'N/A'; ?></td>
                                <?php endif; ?>
                            </tr>
                            <?php endforeach; ?>
                            <?php endif; ?>
